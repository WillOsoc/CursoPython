...
lista01.append("seis") 
# lista01.append("siete", 8) # no permite agregar varios, usar --> .extend
...
print("diez" in lista01) # si el elemento existe en la lista (True/False)

print(lista03[:])
print(lista04[:])	# lista04=lista03*2	# repite "n" veces la lista
